#!/usr/bin/env python  
# -*- coding: utf-8 -*-
#HelloBot1.0_base_controller_node
...
from geometry_msgs.msg import Quaternion, Twist, Pose, TwistStamped
...
class bluetooth_cmd:
    ...
    def main_program(self):  
        ...
        #rospy.Subscriber("/twist_cmd", TwistStamped, self.odom_analysis)
